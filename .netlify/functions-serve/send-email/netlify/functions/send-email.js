...
${message.trim()}`,
    ...
    const errorMessage = error.code === "EAUTH" ? "Gmail rejected the login. Use a Gmail App Password in EMAIL_APP_PASSWORD, not your regular Gmail password." : "Failed to send message. Please try again later.";
    return {
      statusCode: 500,
      headers,
